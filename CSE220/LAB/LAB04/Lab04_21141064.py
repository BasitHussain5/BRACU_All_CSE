...
class DoublyList:
  ...
  def remove(self, idx):
    ...
    remove_node = self.nodeAt(idx)
    prev_of_remove_node = remove_node.prev
    next_of_remove_node = remove_node.next
    prev_of_remove_node.next = next_of_remove_node
    next_of_remove_node.prev = prev_of_remove_node    
    remove_node.next = remove_node.prev = None
    return str(remove_node.element)
